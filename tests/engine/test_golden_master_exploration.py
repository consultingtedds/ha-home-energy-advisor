...
_GUEST = "sensor.coarse_step_aircon_energy_usage_cycle"
_SLOW_POLL = "sensor.slow_poll_aircon_energy_usage_cycle"
...
def test_coarse_step_energy_reproduces_the_published_complete_days() -> None:
    # Given — the coarse-step device's raw counter run through the real delta pipeline
...
def test_slow_poll_attributes_the_full_delta_across_an_unavailable_gap() -> None:
    ...
    deltas = _deltas("aircon_raw_batch2.json", _SLOW_POLL)
