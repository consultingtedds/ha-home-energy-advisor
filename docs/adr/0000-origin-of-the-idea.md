...
* How much did the tumble dryer actually cost to run today?
...
For example, some users may wish to prioritise discretionary loads such as tumble dryers or EV charging, while treating essential appliances differently.
