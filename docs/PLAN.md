...
1. Install and configure a diverse device set on homeassistant.example.net: 9 aircons (cycle-resetting), tumble dryer + water heaters (lifetime counters via Zigbee2MQTT), utility plug (cloud-polled Tuya), wall lights (power-only)
